const LandingPage = () => {
  return (
    <div className="bg-gradient-to-br from-blue-600 to-blue-400 min-h-screen">
      {/* Navbar */}
      <nav className="bg-transparent absolute top-0 inset-x-0 z-10">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <a href="#" className="text-white hover:text-blue-200 px-3 py-2 rounded-md text-sm font-medium">Features</a>
                <a href="#" className="text-white hover:text-blue-200 px-3 py-2 rounded-md text-sm font-medium">About</a>
                <a href="#" className="text-white hover:text-blue-200 px-3 py-2 rounded-md text-sm font-medium">Contact</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="relative">
        <div className="absolute inset-0">
          <img className="w-full h-full object-cover" src="/hero-bg.jpg" alt="Hero Background" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 text-center">
          ...
          <div className="flex justify-center">
            <a href="./signup" className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-md text-lg font-medium mr-4">
              Sign Up
            </a>
            <a href="./login" className="bg-transparent border-2 border-white text-white px-6 py-3 rounded-md text-lg font-medium hover:bg-white hover:text-blue-500">
              Login
            </a>
          </div>
        </div>
